...
| `.antigravity/skills/` | Your skills: `/onboard`, `/audit`, `/level-up`. Add more via `/level-up`. |
...
| `.antigravity/agents/` | You need a sub-assistant for repeatable, multi-step research/writing | Agents run on cheaper models in their own context - keep your main session lean |
