...
- **Q2 Priorities (Next 90 Days)**:
  1. Complete Harvard CS50 and master computer science fundamentals.
  2. Build a deep understanding of C/C++ logic and OOP in C++.
  3. Start Data Structures & Algorithms (DSA) and gain intensive practical experience building projects with AI/agents.
...
- **Customer interactions**: Gmail, LinkedIn, Reddit
